...
function _sanitize(obj, options = {}) {
    const replaceWith = options.hasOwnProperty('replaceWith') &&
    ...
    const target = (0, lodash_clonedeep_1.default)(obj);
    ...
    function _recursiveSanitize(current) {
